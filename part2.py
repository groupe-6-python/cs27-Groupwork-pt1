...
class Student(Person):
    ...
    def display_information(self):
        ...
        print(f"Delivery Year: {self.academic_year} ")
        print(f"Expiration Year: {self.academic_year + 1} ")
        print(f"Start Year: {self.start_year} ")
        print(f"Finish Year: {self.calculate_finish_year()} ")
        print("--------------------------------------------------")
    ...
    def valide_academic_year(self):
        ...
        if self.academic_year in (current_year, current_year - 1):
            return True
        else:
            print(f"enter a valid academic year (should be {current_year} or {current_year-1})")
            return False
